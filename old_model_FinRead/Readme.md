The folder **FinRead_ICON2021_Demo** contains the notebook **FinRead_ICON21_Demo_Readability_System.ipynb** which was presented as a demo at ICON 2021 (http://icon2021.nits.ac.in/coloc_events.html).
